package com.frt.customer.bean.decoderoutekey;
...
public class DecodeRoute {
    ...
    public DecodeRoute(Context context, GoogleMap googleMap, List<LatLng> polyz) {
        this.context = context;
        this.googleMap = googleMap;
        this.polyz = polyz;
    }
    ...
    public void start() {
        ...
        googleMap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback() {
            ...
            public void onMapLoaded() {
                ...
                BitmapDrawable bitmapdraw = (BitmapDrawable) context.getResources().getDrawable(R.drawable.ic_pin);
                Bitmap b = bitmapdraw.getBitmap();
                Bitmap smallMarker = Bitmap.createScaledBitmap(b, 50, 50, false);


                BitmapDrawable bitmapdrawdropoff = (BitmapDrawable) context.getResources().getDrawable(R.drawable.ic_pin);
                Bitmap drooff = bitmapdrawdropoff.getBitmap();
                Bitmap smallMarkerdropoff = Bitmap.createScaledBitmap(drooff, 50, 50, false);
                ...
                googleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(Marker marker) {
                        if (marker.equals(sourceMarker)) {
                            Log.e("fkgkjghkjfdhgjkfdg", "PickUpMarker");
                            markerlistiner("PickUpMarker");
                            clickevent="PickUpMarker";

                        } else {
                            Log.e("fkgkjghkjfdhgjkfdg", "Destination");
                            markerlistiner("Destination");
