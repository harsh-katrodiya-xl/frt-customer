...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    private ArrayList<PlaceAutocomplete> mResultListCollection = new ArrayList<>();
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    try {
                        ...
                        Log.e("SearchedValues", "1.mResultList.size()=> " + mResultList.size());
                    }catch (Exception e)
                    {
                        Log.e("SearchedValues", "error occur => " + e.getLocalizedMessage());
                    }
                    if (mResultList != null) {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    ...
                    Log.e("SearchedValues", "1.----------publishResults---------mResultList.size()=> " + mResultList.size());
    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
       ...
       // AutocompleteFilter filter = new AutocompleteFilter.Builder().setCountry("SA").build();
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View convertView = layoutInflater.inflate(R.layout.layout_place_recycler_item_layout, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull PredictionHolder mPredictionHolder, final int i) {
        ...
        Log.e("SearchedValues", i+"<<position -- 3.mResultList.size()=> " + mResultList.get(i).address);
        Log.e("autocomplateeeeeeeeeeee", "address==>" + mResultList.get(i).address);
        Log.e("autocomplateeeeeeeeeeee", "area==>" + mResultList.get(i).area);
        Log.e("autocomplateeeeeeeeeeee", "area==>" + mResultList.get(i).area);
    }

    @Override
    public int getItemCount() {
        Log.e("SearchedValues", "2.mResultList.size()=> " + mResultList.size());
...
//            itemView.setOnClickListener(this);
            mRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Log.e("PredictionHolder", "onClick: "+e.getLocalizedMessage() );
                    }
