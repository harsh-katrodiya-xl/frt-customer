...
public class CountryCodePicker extends RelativeLayout {
    ...
    static int LIB_DEFAULT_COUNTRY_CODE = 20;
    ...
    LinearLayout relativeClickConsumer;
    ...
    private void init(AttributeSet attrs) {
        ...
        holder = (LinearLayout) holderView.findViewById(R.id.countryCodeHolder);
        ...
        relativeClickConsumer = (LinearLayout) holderView.findViewById(R.id.rlClickConsumer);
        codePicker = this;
...
//        }
    ...
    private LinearLayout getHolder() {
        return holder;
    }

    private void setHolder(LinearLayout holder) {
        this.holder = holder;
    }
